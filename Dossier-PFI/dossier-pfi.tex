...
\begin{document}
    ...
    \begin{metier}{Ingénieur Rendu}
        ...
        \mproperty{Profil requis}{...}
        \mproperty{Compétences}{...}
        \mproperty{Interet du poste}{...}
        \mproperty{Difficultés du poste}{...}
        ...
        \mproperty{Annonces}{\url{https://goo.gl/tMsePF}}
    \end{metier}

    \bigskip

    \begin{metier}{Ingénieur Cloud}
        \mproperty{Secteur d'activité}{0 \euro\ par mois}
        \mproperty{Salaire}{...}
        \mproperty{Profil requis}{...}
        \mproperty{Compétences}{...}
        \mproperty{Interet du poste}{...}
        \mproperty{Difficultés du poste}{...}
        \mproperty{Définition}{...}
    \end{metier}

    \bigskip

    \begin{metier}{Autre métier}
        \mproperty{Secteur d'activité}{0 \euro\ par mois}
        \mproperty{Salaire}{...}
        \mproperty{Profil requis}{...}
        \mproperty{Compétences}{...}
