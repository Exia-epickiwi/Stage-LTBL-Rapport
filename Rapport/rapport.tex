...
\begin{document}
    ...
    Benjamin \bsc{Petit}\hspace{\fill}Baptiste \bsc{Saclier}

    \includegraphics[scale=0.15]{img/signature-mds.png}\hspace{\fill}\includegraphics[scale=0.9]{img/signature.jpg}
